      ...
      <form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><select name="ebanx_express_status">
          ...
          <tr>
            ...
            <td><input type="text" name="ebanx_express_merchant_key" value="<?php echo $ebanx_express_merchant_key ?>" size="110" />
          ...
          <tr>
            ...
            <td><select name="ebanx_express_mode">
          ...
          <tr>
            ...
            <td><select name="ebanx_express_order_status_ca_id">
          ...
          <tr>
            ...
            <td><select name="ebanx_express_order_status_co_id">
                <?php foreach ($order_statuses as $order_status): ?>
          ...
          <tr>
            ...
            <td><select name="ebanx_express_order_status_op_id">
                <?php foreach ($order_statuses as $order_status): ?>
          ...
          <tr>
            ...
            <td><select name="ebanx_express_order_status_pe_id">
                <?php foreach ($order_statuses as $order_status): ?>
          ...
          <tr>
            ...
            <td><select name="ebanx_express_order_status_refund_id">
                <?php foreach ($order_statuses as $order_status): ?>
          ...
          <tr>
            ...
            <td><select name="ebanx_express_order_status_chargeback_id">
                <?php foreach ($order_statuses as $order_status): ?>
          ...
          <tr>
            ...
            <td><select name="ebanx_express_geo_zone_id">
          ...
          <tr>
            ...
            <td><select name="ebanx_express_enable_installments">
          ...
          <tr>
            ...
            <td><input type="text" name="ebanx_express_installments_interest" value="<?php echo floatval($ebanx_express_installments_interest) ?>" /></td>
          </tr>

          <tr>
            <td>Logs</td>
            <td>
              <a class="button" href="<?php echo $this->url->link('payment/ebanx_express/viewLog') ?>&token=<?php echo $_SESSION['token'] ?>" target="_blank">View log</a>
              <a class="button" href="<?php echo $this->url->link('payment/ebanx_express/clearLog') ?>&token=<?php echo $_SESSION['token'] ?>" target="_blank">Clear log</a>
            </td>
          </tr>

          <tr>
            <td><?php echo $entry_sort_order ?></td>
            <td><input type="text" name="ebanx_express_sort_order" value="<?php echo $ebanx_express_sort_order ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
